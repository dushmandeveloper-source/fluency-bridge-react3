  ...
  return (
    ...
    >
      <div className="relative w-full h-28 sm:h-40 md:h-52 lg:h-60 overflow-hidden bg-slate-200 rounded-t-2xl sm:rounded-t-[2rem]">
        ...
        <div
          className={`absolute top-1.5 sm:top-3 ${iconPositionClass} w-10 h-10 sm:w-14 sm:h-14 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-white rounded-lg sm:rounded-2xl flex items-center justify-center shadow-lg border border-slate-50 transition-transform group-hover:-translate-y-2 overflow-hidden`}
        >
      ...
      <div className="relative bg-slate-200 rounded-b-2xl sm:rounded-b-[2rem] px-4 sm:px-6 md:px-7 pt-3 sm:pt-6 pb-3 sm:pb-7 flex flex-col flex-1">
        ...
        <p className="text-slate-500 text-[0.65rem] sm:text-sm md:text-base leading-relaxed font-medium mb-3 sm:mb-4 line-clamp-2 flex-1">{description}</p>

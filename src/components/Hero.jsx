...
export default function Hero() {
  ...
  return (
    <header className="relative min-h-[480px] sm:min-h-[560px] md:h-[65vh] md:min-h-[560px] w-full flex items-center overflow-hidden z-10 bg-gradient-to-br from-slate-900 via-[#0b1f3a] to-slate-900 py-20 md:py-0">
      <img
        src={bannerImage}

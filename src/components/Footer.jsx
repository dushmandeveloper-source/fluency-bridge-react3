      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
        ...
        <div>
          ...
          <a href="#/" className="flex items-center gap-3 mb-5 interactive-el" aria-label="Go to home">
            <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-white border-2 border-white flex items-center justify-center overflow-hidden p-2 shrink-0 drop-shadow-[0_0_14px_rgba(255,255,255,1)] drop-shadow-[0_0_28px_rgba(255,255,255,0.85)] drop-shadow-[0_0_45px_rgba(255,255,255,0.6)]">
              <img
          ...
          <div className="flex gap-3">
            <a href="#" aria-label="Facebook" className="flex items-center justify-center w-9 h-9 rounded-full bg-white hover:opacity-80 transition interactive-el">
              <svg className="w-5 h-5" viewBox="0 0 24 24" aria-hidden="true">
                <path fill="#1877F2" d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="#" aria-label="LinkedIn" className="flex items-center justify-center w-9 h-9 rounded-full bg-white hover:opacity-80 transition interactive-el">
              <svg className="w-5 h-5" viewBox="0 0 24 24" aria-hidden="true">
                <path fill="#0A66C2" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
            <a href="#" aria-label="Instagram" className="flex items-center justify-center w-9 h-9 rounded-full bg-white hover:opacity-80 transition interactive-el">
              <svg className="w-5 h-5" viewBox="0 0 24 24" aria-hidden="true">
                <defs>
            ...
            <a href="#" aria-label="YouTube" className="flex items-center justify-center w-9 h-9 rounded-full bg-white hover:opacity-80 transition interactive-el">
              <svg className="w-5 h-5" viewBox="0 0 24 24" aria-hidden="true">

...
// About Us 2 — the same editorial section layout, image sizes and spacing as the
// main About Us page, but rebuilt as glassmorphism (liquid-glass) text panels
// floating over the shared fixed banner image. BannerBackground (fixed) supplies
// the zooming photo, dark overlay and sparkle particles. The original page lives
// untouched at #/about; this is the separate #/about2 version.
...
export default function AboutUs2() {
  ...
  // matching the motion on the main About Us page.
  useEffect(() => {
  ...
  return (
    <BannerBackground
      ...
      particleCount={52}
    >
      <main className="about2-glass relative z-20 w-full">

            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {FEATURES.map((f, i) => (
                <Reveal key={f.title} delay={i * 100} className="reveal liquid-glass rounded-3xl p-5 sm:p-7 flex flex-col items-center text-center gap-3">
                  <span className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full" style={{ backgroundColor: 'rgba(255,255,255,0.9)', boxShadow: '0 1px 4px rgba(0,0,0,0.15)', color: f.color }}>
